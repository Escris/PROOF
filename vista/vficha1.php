	...
	<table width="400">
        <tr>
           ...
           <tr>
        	...
        	<td><?php echo $dat6[0]['nfic']?>
            <input type="hidden" name="nfic" size="30" maxlength="50" required="required" value="<?php echo $dat6[0]['nfic']?>"/>            <input type="hidden" name="actu" value="actu"/></td>
        </tr>
          <tr>
        	<td colspan="2" align="center">
            	</br>               
        	...
        	<tr>
			<td>Fecha Inicio</td><td><input type="date"  name="finific" value="<?php echo $dat6[0]['finific']?>" />
			</td>
            </tr>
              <tr>
        	<td colspan="2" align="center">
            ...
            <tr>
			<td>Fecha Fin</td><td><input type="date"  name="ffinfic" value="<?php echo $dat6[0]['ffinfic']?>" />
 			</td>
     	</tr>
          <tr>
        	<td colspan="2" align="center">
 	...
 	//Select
	  ...
	  ?>
            ...
            <option value="<?php echo $dat2[$i]['codval']?>" <?php if($dat6[0]['jorfic']==$dat2[$i]['codval']) echo 'selected'; ?> ><?php echo $dat2[$i]['nomval']?></option>
 	...
 	//Select
	  ...
	  ?>
            ...
            <option value="<?php echo  $dat3[$s]['codval']?>" <?php if($dat6[0]['ofefic']==$dat3[$s]['codval']) echo 'selected'; ?>><?php echo $dat3[$s]['nomval']?></option>
 	...
 	//Select
	  ...
	  ?>
            ...
            <option value="<?php echo $dat4[$i]['codval']?>" <?php if($dat6[0]['modfic']==$dat4[$i]['codval']) echo 'selected'; ?>><?php echo $dat4[$i]['nomval']?></option>
 	...
 	//Select
	  ...
	  ?>
            <option value="<?php echo $dat1[$i]['codpro'] ?>" <?php if($dat6[0]['codpro']==$dat1[$i]['codpro']) echo 'selected'; ?>><?php echo $dat1[$i]['nompro'] ?></option>
            <?php  } ?>
            	</select>
            </td>
        </tr>
