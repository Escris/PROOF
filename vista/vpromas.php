...
<form action="home.php?pac=112" method="post" enctype="multipart/form-data">
...
<form name="form2">
<a href="archivo/programa.xlsx" style="font-size:12px; text-decoration:none; color:black; font-weight:bold">Descargar Plantilla<br/><br/><img src="image/excel.gif"/></a>
