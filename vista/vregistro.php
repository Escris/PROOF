...
<select name="tdocapre" style="width: 195px;" onblur="probar(id='tdocapre', 2)" required>
  ...
  <tr>
    ...
    <span id="passwd_sitio"><input type="text" name="telapre" size="25"  maxlength="30" required="required" placeholder="Tel&eacute;fono" id="telapre" onblur="probar1(id='telapre', 7)"/></span>
    ...
    <input type="email" name="emaapre" size="25" maxlength="30" required="required" placeholder="Email" id="emaapre" onblur="probar1(id='emaapre', 8)" />
  ...
  <tr>
    ...
    <input type="text" name="dirapre" size="25" maxlength="30" required="required" placeholder="Direcci&oacute;n" id="dirapre" onblur="probar1(id='dirapre', 9)"/></td>
    <td valign="bottom">
  ...
  <tr>
    <td valign="bottom"><input type="text" name="nlmiapre" size="25"  maxlength="30"  placeholder="Numero de la Libreta Militar"/></td>
    <td valign="bottom"><div align="left" id="20" class="rojo">*</div>
    <input type="password" name="pass" id="contraseña" size="25"  maxlength="30" required="required" placeholder="Contrase&ntilde;a de Minimo 8 caracteres" onblur="vali(id='contraseña', 20)"/>
    </td>
    <td valign="bottom">
    <input type="password" name="pass1" size="25" id="confirmar"  maxlength="30" onblur="comparar()" required="required" placeholder="Confirmar Contrase&ntilde;a"/></td>
  </tr>
  <tr>
    <td valign="bottom">
  ...
  <td valign="bottom"><div align="left" id="12" class="rojo">*</div>
    <input type="text" name="llamaapre" size="25"  maxlength="30" required="required" placeholder="Familiar del aprendiz" id="llamaapre" onblur="probar1(id='llamaapre', 12)"/>
    </td>
  <td valign="bottom"><div align="left" id="13" class="rojo">*</div>
    <input type="text" name="teleapre" size="25"  maxlength="30" required="required" placeholder="Tel&eacute;fono del Familiar" id="teleapre" onblur="probar1(id='teleapre', 13)"/>
    </td>    
  </tr>
